            ...
            if k in what._structure_properties:
                if type(v) == list:
                    for sub in v:
                        ...
                        elif type(sub) in [str, str] and sub.startswith('http'):
                ...
                elif type(v) in [str, str] and (v.startswith('http') or v.startswith('urn:') or v.startswith('_:')):
                    setattr(what, k, v)
                else:
